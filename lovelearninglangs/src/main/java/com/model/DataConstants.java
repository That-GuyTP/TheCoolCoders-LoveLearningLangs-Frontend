...
public abstract class DataConstants {
    ...
    //Phrases Details
    protected static final String PHRASES_JSON_FILE = "src/main/java/com/data/Phrases.json";
    ...
    //Word Details
    protected static final String WORDS_JSON_FILE = "src/main/java/com/data/Words.json";
